...
import { TrendingUp, Calendar, Scissors, DollarSign, Clock, Plus } from 'lucide-react';
...
const BarberoDashboard: React.FC = () => {
    ...
    const idBarbero = user?.id_barbero || 4; 

    const { stats, bookings, info, isLoading, refetch } = useBarberoDashboard(idBarbero, period);
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-3 bg-[#3366FF] text-white px-8 py-4 rounded-2xl font-black shadow-xl shadow-blue-200 hover:bg-rose-500 transition-all"
                    >
                        <Plus size={24} />
                        NUEVA CITA MANUAL
                    </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border-4 border-white relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-10 opacity-10 group-hover:scale-110 transition-transform">
                            <DollarSign size={80} className="text-[#3366FF]" />
                        </div>
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border-4 border-white relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <h2 className="text-4xl font-black text-slate-900">45 Min</h2>
                ...
                <div className="bg-white rounded-[3.5rem] shadow-2xl overflow-hidden border-8 border-white">
                    <div className="p-10 border-b-4 border-slate-50 flex justify-between items-center">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-3xl font-black text-slate-900">Agenda del Día</h2>
                        </div>
                        <div className="flex items-center gap-2 bg-slate-50 p-2 rounded-2xl">
                             <Calendar size={20} className="text-[#3366FF] ml-2" />
