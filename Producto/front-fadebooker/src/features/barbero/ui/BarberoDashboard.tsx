...
import { TrendingUp, Calendar, Scissors, DollarSign, Clock, Plus, LayoutDashboard, Store } from 'lucide-react';
...
const BarberoDashboard: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'dashboard' | 'tienda'>('dashboard');
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                    ...
                    <div className="flex items-center gap-4">
                        {user?.rol === 'Dueño' && (
                            <div className="flex bg-white p-2 rounded-2xl shadow-lg border-2 border-slate-100">
                                <button 
                                ...
                                >
                                    <LayoutDashboard size={16} /> Agenda
                                </button>
                                <button 
